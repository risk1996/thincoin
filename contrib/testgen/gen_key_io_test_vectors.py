...
SCRIPT_ADDRESS_TEST = 226
PUBKEY_ADDRESS_REGTEST = 100
SCRIPT_ADDRESS_REGTEST = 226
PRIVKEY = 200
PRIVKEY_TEST = 183
PRIVKEY_REGTEST = 183
...
# hrp for main net, test net, and regtest net
hrps = ['thc', 'tthc', 'rthc']
# templates for valid bech32 sequences
bech32_templates = [
  # hrp, version, witprog_size, metadata, output_prefix
  (hrps[0],  0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  (hrps[0],  0, 32, (False, 'main',    None, True), p2wsh_prefix),
  (hrps[0],  1,  2, (False, 'main',    None, True), (OP_1, 2)),
  (hrps[1],  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  (hrps[1],  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  (hrps[1],  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  (hrps[2],  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  (hrps[2],  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  (hrps[2], 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('xxx'  ,  0, 20, False, False, False),
  (hrps[1], 17, 32, False, False, False),
  (hrps[2],  3,  1, False, False, False),
  (hrps[0], 15, 41, False, False, False),
  (hrps[1],  0, 16, False, False, False),
  (hrps[2],  0, 32, True,  False, False),
  (hrps[0],  0, 16, True,  False, False),
  (hrps[1],  0, 32, False, True,  False),
  (hrps[2],  0, 20, False, False, True)
]
