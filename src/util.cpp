...
const char * const BITCOIN_CONF_FILENAME = "thincoin.conf";
const char * const BITCOIN_PID_FILENAME = "thincoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Thincoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Thincoin";
#else
    // Unix
    return pathRet / ".thincoin";
#endif
#endif
}
