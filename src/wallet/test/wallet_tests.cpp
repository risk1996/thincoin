...
BOOST_FIXTURE_TEST_CASE(rescan, TestChain100Setup)
{
    ...
    // and new block files.
    {
        ...
        BOOST_CHECK_EQUAL(wallet.GetImmatureBalance(), 2 * Params().GetConsensus().nInitialSubsidy * COIN);
    }
    ...
    // file.
    {
        ...
        BOOST_CHECK_EQUAL(wallet.GetImmatureBalance(), Params().GetConsensus().nInitialSubsidy * COIN);
    }
...
BOOST_FIXTURE_TEST_CASE(coin_mark_dirty_immature_credit, TestChain100Setup)
{
    ...
    wtx.MarkDirty();
    wallet.AddKeyPubKey(coinbaseKey, coinbaseKey.GetPubKey());
    BOOST_CHECK_EQUAL(wtx.GetImmatureCredit(), Params().GetConsensus().nInitialSubsidy * COIN);
}
...
BOOST_FIXTURE_TEST_CASE(ListCoins, ListCoinsTestingSetup)
{
    ...
    BOOST_CHECK_EQUAL(Params().GetConsensus().nInitialSubsidy * COIN, wallet->GetAvailableBalance());
