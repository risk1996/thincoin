...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s thincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  thincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thincoin transaction") + "\n" +
              "  thincoin-tx [options] -create [commands]   " + _("Create hex-encoded thincoin transaction") + "\n" +
              "\n";
