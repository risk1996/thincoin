...
BOOST_AUTO_TEST_CASE(get_next_work)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 0x1c049fc6);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_pow_limit)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 0x1e0d6e43);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_upper_limit_actual)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 0x1b02a669);
}
