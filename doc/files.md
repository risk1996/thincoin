...
* thincoin.conf: contains configuration settings for thincoind or thincoin-qt
* thincoind.pid: stores the process id of thincoind while running
...
* debug.log: contains debug information and general logging generated by thincoind or thincoin-qt
