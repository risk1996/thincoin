Thincoin Core version *0.15.1* is now available from:

  <https://download.thincoin.org/thincoin-0.15.1/>
...
A number of changes to the way Thincoin Core deals with peer connections and invalid blocks
