...
"""Verify that starting thincoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start thincoin with -h for help text")
        ...
        self.log.info("Start thincoin with -version for version information")
